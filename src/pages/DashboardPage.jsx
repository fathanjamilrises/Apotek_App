  ...
  return (
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div class="card bg-white w-96 shadow-xl">
            <div class="card-body">
              <h2 class="card-title text-lg font-normal">Stok Obat</h2>
              <div class="flex">
                <h1 class="text-3xl font-bold  text-blue-700">90</h1>
          ...
          <div class="card bg-white w-96 shadow-xl">
            <div class="card-body">
              <h2 class="card-title text-lg font-normal">Jumlah Karyawan</h2>
              <div class="flex">
                <h1 class="text-3xl font-bold  text-blue-700">15</h1>
              </div>
          ...
          <div class="card bg-white w-96 shadow-xl">
            <div class="card-body">
              <h2 class="card-title text-lg font-normal">Total Transaksi</h2>
              <div class="flex">
                <h1 class="text-3xl font-bold  text-blue-700">5</h1>
              </div>
